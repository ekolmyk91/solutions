                        ...
                        <table class="table table-hover table-listing">
                            <thead>
                                <tr>
                                    ...
                                    <th is='sortable' :column="'surname'">{{ trans('admin.member.columns.surname') }}</th>
                                    <th is='sortable' :column="'email'">{{ trans('admin.member.columns.email') }}</th>
                                    <th is='sortable' :column="'birthday'">{{ trans('admin.member.columns.birthday') }}</th>
                                    <th is='sortable' :column="'department'">{{ trans('admin.member.columns.department') }}</th>
                                    <th is='sortable' :column="'position'">{{ trans('admin.member.columns.position') }}</th>
